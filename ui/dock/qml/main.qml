...
Item {
    ...
    Rectangle {
        ...
        property var borderColor: root.compositing ? NemacUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
                                                                           : Qt.rgba(0, 0, 0, 0.2) : NemacUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.15)
                                                                                                                           : Qt.rgba(0, 0, 0, 0.15)

        anchors.fill: parent
        radius: root.compositing && Settings.style === 0 ? windowRadius : 0
        color: NemacUI.Theme.darkMode ? "#666666" : "#E6E6E6"
        opacity: root.compositing ? NemacUI.Theme.darkMode ? 0.5 : 0.5 : 0.9
    ...
    GridLayout {
        ...
        DockItem {
            ...
            Rectangle {
                ...
                color: "transparent"
                border.color: NemacUI.Theme.textColor
                radius: height * 0.3
                border.width: 1 / NemacUI.Units.devicePixelRatio
                border.pixelAligned: NemacUI.Units.devicePixelRatio > 1 ? false : true
