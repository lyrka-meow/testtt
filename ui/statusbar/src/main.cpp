...
int main(int argc, char *argv[])
{
    ...
    const char *uri = "Nemac.StatusBar";
    ...
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/nemac-statusbar/translations/").arg(QLocale::system().name());
    ...
    if (!QDBusConnection::sessionBus().registerService("com.nemac.Statusbar")) {
        return -1;
    }
