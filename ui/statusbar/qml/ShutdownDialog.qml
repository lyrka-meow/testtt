/*
 * Copyright (C) 2021 - 2022 NemacDE Team.
 *
...
ControlCenterDialog {
    ...
    width: _mainLayout.implicitWidth + NemacUI.Units.largeSpacing * 3
    height: _mainLayout.implicitHeight + NemacUI.Units.largeSpacing * 3
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            StandardCard {
                ...
                icon: NemacUI.Theme.darkMode ? "qrc:/images/dark/system-shutdown.svg"
            ...
            StandardCard {
                Layout.preferredWidth: 96
                Layout.preferredHeight: 96
                icon: NemacUI.Theme.darkMode ? "qrc:/images/dark/system-reboot.svg"
            ...
            StandardCard {
                Layout.preferredWidth: 96
                Layout.preferredHeight: 96
                icon: NemacUI.Theme.darkMode ? "qrc:/images/dark/system-log-out.svg"
            ...
            StandardCard {
                Layout.preferredWidth: 96
                Layout.preferredHeight: 96
                icon: NemacUI.Theme.darkMode ? "qrc:/images/dark/system-lock-screen.svg"
            ...
            StandardCard {
                Layout.preferredWidth: 96
                Layout.preferredHeight: 96
                icon: NemacUI.Theme.darkMode ? "qrc:/images/dark/system-suspend.svg"
