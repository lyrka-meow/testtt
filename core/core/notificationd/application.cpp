...
Application::Application(int& argc, char** argv)
    ...
    , m_instance(false)
{
    if (QDBusConnection::sessionBus().registerService("com.nemac.Notification")) {
        setOrganizationName("nemacde");

        // Translations
        QLocale locale;
        QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/nemac-notificationd/translations/").arg(locale.name());
        ...
        qmlRegisterType<NotificationsModel>("Nemac.Notification", 1, 0, "NotificationsModel");
        qmlRegisterType<HistoryModel>("Nemac.Notification", 1, 0, "HistoryModel");
        qmlRegisterType<ScreenHelper>("Nemac.Notification", 1, 0, "ScreenHelper");
        qmlRegisterType<NotificationPopup>("Nemac.Notification", 1, 0, "NotificationPopup");
...
bool Application::parseCommandLineArgs()
{
    ...
    if (m_instance) {
        ...
        QDBusInterface iface("com.nemac.Notification",
                             "/Notification",
                             "com.nemac.Notification",
