...
var allowlist = [
    "nemac-launcher nemac-launcher",
    "nemac-screenshot nemac-screenshot"
];
...
var nemacPopupsEffect = {
    loadConfig: function () {
        nemacPopupsEffect.fadeInDuration = animationTime(100);
        nemacPopupsEffect.fadeOutDuration = animationTime(100) * 4;
    },
    slotWindowAdded: function (window) {
        ...
        window.fadeInAnimation = animate({
            ...
            duration: nemacPopupsEffect.fadeInDuration,
            type: Effect.Opacity,
            from: 0.0,
            to: 1.0
        });
    ...
    slotWindowClosed: function (window) {
        ...
        window.fadeOutAnimation = animate({
            ...
            duration: nemacPopupsEffect.fadeOutDuration,
            type: Effect.Opacity,
            from: 1.0,
            to: 0.0
        });
    ...
    init: function () {
        nemacPopupsEffect.loadConfig();

        effect.configChanged.connect(nemacPopupsEffect.loadConfig);
        effects.windowAdded.connect(nemacPopupsEffect.slotWindowAdded);
        effects.windowClosed.connect(nemacPopupsEffect.slotWindowClosed);
        effects.windowDataChanged.connect(nemacPopupsEffect.slotWindowDataChanged);
    }
};

nemacPopupsEffect.init();
