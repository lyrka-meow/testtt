...
Item {
    ...
    property int widthValue: _mainLayout.implicitWidth + NemacUI.Units.largeSpacing * 3
    property int heightValue: _mainLayout.implicitHeight + NemacUI.Units.largeSpacing * 3
    ...
    ColumnLayout {
        ...
        anchors.bottomMargin: NemacUI.Units.largeSpacing * 1.5
