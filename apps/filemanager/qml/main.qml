...
NemacUI.Window {
    ...
    header.height: 36 + NemacUI.Units.largeSpacing
    ...
    headerItem: Item {
        RowLayout {
            ...
            anchors.topMargin: NemacUI.Units.smallSpacing * 1.5
            ...
            IconButton {
                ...
                source: NemacUI.Theme.darkMode ? "qrc:/images/dark/go-previous.svg"
            ...
            IconButton {
                Layout.fillHeight: true
                implicitWidth: height
                source: NemacUI.Theme.darkMode ? "qrc:/images/dark/go-next.svg"
            ...
            IconButton {
                ...
                property var gridSource: NemacUI.Theme.darkMode ? "qrc:/images/dark/grid.svg" : "qrc:/images/light/grid.svg"
                property var listSource: NemacUI.Theme.darkMode ? "qrc:/images/dark/list.svg" : "qrc:/images/light/list.svg"
    ...
    RowLayout {
        ...
        SideBar {
            id: _sideBar
            Layout.fillHeight: true
            width: 180 + NemacUI.Units.largeSpacing
