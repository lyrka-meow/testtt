...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        color: NemacUI.Theme.darkMode ? Qt.lighter(NemacUI.Theme.secondBackgroundColor, 1.3)
    ...
    ListView {
        ...
        highlight: Rectangle {
            ...
            color: Qt.rgba(NemacUI.Theme.highlightColor.r,
                           ...
                           NemacUI.Theme.highlightColor.b, NemacUI.Theme.darkMode ? 0.3 : 0.1)
            smooth: true
        }
        ...
        delegate: MouseArea {
            ...
            width: _name.width + NemacUI.Units.largeSpacing
            hoverEnabled: true
            z: -1
            ...
            Rectangle {
                anchors.fill: parent
                radius: NemacUI.Theme.smallRadius
                color: _item.pressed ? Qt.rgba(NemacUI.Theme.textColor.r,
                                                   NemacUI.Theme.textColor.g,
                                                   NemacUI.Theme.textColor.b, NemacUI.Theme.darkMode ? 0.05 : 0.1) :
                       _item.containsMouse ? Qt.rgba(NemacUI.Theme.textColor.r,
                                                     NemacUI.Theme.textColor.g,
    ...
    TextField {
        ...
        color: NemacUI.Theme.darkMode ? "white" : "black"

        background: Rectangle {
            radius: NemacUI.Theme.smallRadius
            color: NemacUI.Theme.darkMode ? Qt.lighter(NemacUI.Theme.secondBackgroundColor, 1.7)
                                         : NemacUI.Theme.secondBackgroundColor
            border.width: 1
