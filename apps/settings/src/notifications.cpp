 ...
 *
 * Author:     Kate Leet <kateleet@nemacde.com>
 *
...
Notifications::Notifications(QObject *parent)
    : QObject(parent)
    , m_iface("com.nemac.Notification",
              "/Notification",
              "com.nemac.Notification", QDBusConnection::sessionBus())
{
    m_doNotDisturb = m_iface.property("doNotDisturb").toBool();

    QDBusConnection::sessionBus().connect("com.nemac.Notification",
                                          "/Notification",
