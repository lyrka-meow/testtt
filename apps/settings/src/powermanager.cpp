...
PowerManager::PowerManager(QObject *parent)
    : QObject(parent)
    , m_iface("com.nemac.PowerManager",
              "/CPUManagement", "com.nemac.CPUManagement",
    ...
    , m_mode(-1)
{
    ...
    QSettings settings(QSettings::UserScope, "nemacde", "power");
...
void PowerManager::setIdleTime(int idleTime)
{
    if (m_idleTime != idleTime) {
        ...
        QDBusInterface iface("com.nemac.PowerManager",
                             "/PowerManager", "com.nemac.PowerManager",
                             QDBusConnection::sessionBus());
        if (iface.isValid()) {
