...
NemacUI.Window {
    ...
    ColumnLayout {
        ...
        Image {
            ...
            source: NemacUI.Theme.darkMode ? "qrc:/images/dark/world.svg" : "qrc:/images/light/world.svg"
            ...
            Item {
                ...
                width: popupText.implicitWidth + NemacUI.Units.largeSpacing
                height: popupText.implicitHeight + NemacUI.Units.largeSpacing
                ...
                Label {
                    ...
                    color: NemacUI.Theme.highlightedTextColor
                }
            }
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    popupItem.x = mouse.x + NemacUI.Units.smallSpacing * 1.5
                    popupItem.y = mouse.y + NemacUI.Units.smallSpacing * 1.5
