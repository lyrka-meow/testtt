    ...
    Rectangle {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0; color: Qt.rgba(NemacUI.Theme.highlightColor.r,
                                                             NemacUI.Theme.highlightColor.g,
                                                             NemacUI.Theme.highlightColor.b, 1) }
                GradientStop { position: 1.0; color: Qt.rgba(NemacUI.Theme.highlightColor.r,
                                                             NemacUI.Theme.highlightColor.g,
