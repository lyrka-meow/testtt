...
NemacUI.Window {
    ...
    property int contentWidth: _mainLayout.implicitWidth + header.height + NemacUI.Units.largeSpacing * 2
    property int contentHeight: _mainLayout.implicitHeight + header.height + NemacUI.Units.largeSpacing * 2
