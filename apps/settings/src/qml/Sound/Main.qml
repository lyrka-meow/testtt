        ...
        ColumnLayout {
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    height: _itemLayout.implicitHeight + NemacUI.Units.largeSpacing * 2
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Image {
                                ...
                                source: "qrc:/images/" + (NemacUI.Theme.darkMode ? "dark" : "light") + "/" + audioIcon(slider.value / slider.to * 100) + ".svg"
                                smooth: false
                                antialiasing: true
                            }
            ...
            ListView {
                ...
                delegate: Item {
                    width: ListView.view.width
                    height: _layout.implicitHeight + NemacUI.Units.largeSpacing * 2
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Image {
                                ...
                                width: height
                                sourceSize: Qt.size(width, height)
                                source: "qrc:/images/" + (NemacUI.Theme.darkMode ? "dark" : "light") + "/" + microphoneIcon(_slider.value / _slider.to * 100) + ".svg"
                                smooth: false
                                antialiasing: true
                            }
