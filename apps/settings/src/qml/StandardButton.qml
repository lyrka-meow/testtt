...
Button {
    ...
    property color backgroundColor: NemacUI.Theme.darkMode ? "#363636" : "#FFFFFF"
    property color hoveredColor: NemacUI.Theme.darkMode ? Qt.lighter(backgroundColor, 1.3)
                                                       : Qt.darker(backgroundColor, 1.1)
    property color pressedColor: NemacUI.Theme.darkMode ? Qt.lighter(backgroundColor, 1.1)
