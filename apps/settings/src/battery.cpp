...
static const QString s_sServer = "com.nemac.Settings";
static const QString s_sPath = "/PrimaryBattery";
static const QString s_sInterface = "com.nemac.PrimaryBattery";
...
{
    QSettings settings(QSettings::UserScope, "nemacde", "statusbar");
    return settings.value("BatteryPercentage", false).toBool();
}

void Battery::setPercentEnabled(bool value)
{
    QDBusInterface("com.nemac.Statusbar", "/Statusbar").call("setBatteryPercentage", value);
}
