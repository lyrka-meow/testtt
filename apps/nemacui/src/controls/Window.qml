...
Window {
    ...
    property var windowRadius: compositing ? NemacUI.Theme.windowRadius : 0
    ...
    Rectangle {
        ...
        property var borderColor: compositing ? NemacUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    RoundImageButton {
                        ...
                        source: "qrc:/nemacui/kit/images/" + (NemacUI.Theme.darkMode ? "dark/" : "light/") + "minimize.svg"
                    ...
                    RoundImageButton {
                        size: _header.buttonSize
                        source: "qrc:/nemacui/kit/images/" +
                            (NemacUI.Theme.darkMode ? "dark/" : "light/") +
                    ...
                    RoundImageButton {
                        size: _header.buttonSize
                        source: "qrc:/nemacui/kit/images/" + (NemacUI.Theme.darkMode ? "dark/" : "light/") + "close.svg"
    ...
    function showPassiveNotification(message, timeout, actionText, callBack) {
        if (!internal.passiveNotification) {
            var component = Qt.createComponent("qrc:/nemacui/kit/Toast.qml")
