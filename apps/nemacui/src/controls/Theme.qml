...
import QtQuick 2.4
import NemacUI.Core 1.0 as NemacUICore

QtObject {
    id: theme

    property real devicePixelRatio: NemacUICore.ThemeManager.devicePixelRatio

    property bool darkMode: NemacUICore.ThemeManager.darkMode

    property color blueColor: NemacUICore.ThemeManager.blueColor
    property color redColor: NemacUICore.ThemeManager.redColor
    property color greenColor: NemacUICore.ThemeManager.greenColor
    property color purpleColor: NemacUICore.ThemeManager.purpleColor
    property color pinkColor: NemacUICore.ThemeManager.pinkColor
    property color orangeColor: NemacUICore.ThemeManager.orangeColor
    property color greyColor: NemacUICore.ThemeManager.greyColor
    ...
    property color highlightColor: NemacUICore.ThemeManager.accentColor
    ...
    property real fontSize: NemacUICore.ThemeManager.fontSize
    property string fontFamily: NemacUICore.ThemeManager.fontFamily
