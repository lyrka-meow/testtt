...
Item {
    ...
    property var contentWidth: _contentLayout.implicitWidth + NemacUI.Units.largeSpacing * 2

    property var backgroundColor: NemacUI.Theme.secondBackgroundColor
    property var hoveredColor: NemacUI.Theme.darkMode ? Qt.lighter(NemacUI.Theme.secondBackgroundColor, 1.3)
                                                     : Qt.darker(NemacUI.Theme.secondBackgroundColor, 1.05)
    property var pressedColor: NemacUI.Theme.darkMode ? Qt.lighter(NemacUI.Theme.secondBackgroundColor, 1.1)
                                                     : Qt.darker(NemacUI.Theme.secondBackgroundColor, 1.1)

    property var highlightColor: NemacUI.Theme.highlightColor
    ...
    Rectangle {
        id: hoveredRect
        anchors.fill: parent
        anchors.leftMargin: NemacUI.Units.smallSpacing / 2
    ...
    RowLayout {
        ...
        Label {
            ...
            color: control.checked ? NemacUI.Theme.highlightedTextColor
                                   : NemacUI.Theme.textColor
            elide: Text.ElideMiddle
            wrapMode: Text.NoWrap
        }

        NemacUI.TabCloseButton {
            id: _closeButton
            enabled: control.checked
            Layout.preferredHeight: 24
            Layout.preferredWidth: 24
            size: 24
            source: !enabled ? "" : "qrc:/images/" + (NemacUI.Theme.darkMode || control.checked ? "dark/" : "light/") + "close.svg"
