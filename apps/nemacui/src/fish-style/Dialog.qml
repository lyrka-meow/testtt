...
T.Dialog {
    ...
    padding: NemacUI.Theme.hugeRadius
    ...
    header: Item {
        id: _headerItem
        implicitHeight: _headerLabel.visible ? _headerLabel.implicitHeight + NemacUI.Units.largeSpacing : 0
    ...
    footer: DialogButtonBox {
        visible: count > 0
        padding: NemacUI.Units.largeSpacing * 2
    }
}