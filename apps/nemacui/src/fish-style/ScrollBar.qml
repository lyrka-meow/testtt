...
T.ScrollBar {
    ...
    contentItem: Rectangle {
        ...
        color: control.pressed ? NemacUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.4) : Qt.rgba(0, 0, 0, 0.5)
                               : NemacUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.5) : Qt.rgba(0, 0, 0, 0.4)
        opacity: 0.0
    }
